...
Artisan::command('auctions:tutup', function () {
...
Artisan::command('schedule:register', function () {
    ...
    $schedule->exec('php artisan auctions:tutup')
        ->everyMinute()
...
Schedule::command('auctions:tutup')->everyMinute()->appendOutputTo(storage_path('logs/schedule.log'));